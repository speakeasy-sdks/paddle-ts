...
sdk.subscriptionService.cancelSubscription({
  requestBody: {
...
sdk.subscriptionService.createSubscriptionCharge({
  subscriptionCharge: {
...
sdk.subscriptionService.listSubscriptions({
  after: "corporis",
...
sdk.subscriptionService.pauseSubscription({
  requestBody: {
