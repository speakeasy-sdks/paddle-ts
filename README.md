...
(async() => {
  ...
  try {
    ...
    if (e instanceof 400_application/json_object) {
      console.error(e) // handle exception 
    
    } else if (e instanceof 404_application/json_object) {
      console.error(e) // handle exception 
    
    } else if (e instanceof 409_application/json_object) {
      console.error(e) // handle exception 
    
    } else if (e instanceof 500_application/json_object) {
      console.error(e) // handle exception 
    }
  }
