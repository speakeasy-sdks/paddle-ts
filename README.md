...
(async () => {
    ...
    let res;
    try {
        res = await sdk.addresses.create({
            addressCreateInput: {
                city: "Astoria",
                countryCode: CountryCode2.Kn,
                description: "Paddle.com",
        ...
        if (e instanceof create - address_400ApplicationJSON_object) {
            console.error(e); // handle exception
        } else if (e instanceof create - address_401ApplicationJSON_object) {
            console.error(e); // handle exception
        } else if (e instanceof create - address_403ApplicationJSON_object) {
            console.error(e); // handle exception
        } else if (e instanceof create - address_404ApplicationJSON_object) {
            console.error(e); // handle exception
        } else if (e instanceof create - address_500ApplicationJSON_object) {
            console.error(e); // handle exception
        }
    }
