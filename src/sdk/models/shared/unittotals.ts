...
export namespace UnitTotals$ {
    ...
    export const inboundSchema: z.ZodType<UnitTotals, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UnitTotals> = z
        .object({
            discount: z.string().optional(),
            subtotal: z.string().optional(),
            tax: z.string().optional(),
