...
export namespace TransactionUpdate$ {
    ...
    export const inboundSchema: z.ZodType<TransactionUpdate, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, TransactionUpdate> = z
        .object({
