...
import { Adjustment2 } from "./adjustment2";
 ...
 */
export class TransactionIncludesCheckout extends SpeakeasyBase {
    /**
...
export class TransactionIncludes extends SpeakeasyBase {
     ...
     */
    @SpeakeasyMetadata({ elemType: Adjustment2 })
    ...
    @Type(() => TransactionAdjustmentsTotalsInclude)
    adjustmentsTotals?: TransactionAdjustmentsTotalsInclude;
    ...
    @Type(() => TransactionIncludesCheckout)
    checkout?: TransactionIncludesCheckout;
