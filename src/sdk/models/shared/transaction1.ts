 ...
 */
export type Transaction1Checkout = {
    /**
...
export type Transaction1 = {
     ...
     * Paddle Checkout details for this transaction. Always included for automatically-collected transactions. Included where `billing_details.enable_checkout` is `true` for manually-collected transactions.
     */
    checkout?: Transaction1Checkout | null | undefined;
    /**
...
/** @internal */
export namespace Transaction1Checkout$ {
    export type Inbound = {
        url?: string | undefined;
    };

    export const inboundSchema: z.ZodType<Transaction1Checkout, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, Transaction1Checkout> = z
        .object({
            url: z.string().optional(),
        })
        .transform((v) => {
...
export namespace Transaction1$ {
    export type Inbound = {
        ...
        checkout?: Transaction1Checkout$.Inbound | null | undefined;
    ...
    export const inboundSchema: z.ZodType<Transaction1, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            checkout: z.nullable(z.lazy(() => Transaction1Checkout$.inboundSchema)).optional(),
    ...
    export type Outbound = {
        ...
        business_id?: string | undefined;
        checkout?: Transaction1Checkout$.Outbound | null | undefined;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, Transaction1> = z
        .object({
            ...
            checkout: z.nullable(z.lazy(() => Transaction1Checkout$.outboundSchema)).optional(),
