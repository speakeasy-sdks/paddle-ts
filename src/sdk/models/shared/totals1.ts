...
export namespace Totals1$ {
    ...
    export const inboundSchema: z.ZodType<Totals1, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, Totals1> = z
        .object({
            discount: z.string().optional(),
            subtotal: z.string().optional(),
            tax: z.string().optional(),
