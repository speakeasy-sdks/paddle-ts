 ...
 * OK
 */
export type ListAddressesResponseBody = {
...
export type ListAddressesResponse = {
     ...
     * OK
     */
    object?: ListAddressesResponseBody | undefined;
};
...
export namespace ListAddressesResponseBody$ {
    ...
    export type Outbound = {
        data: Array<shared.Address$.Outbound>;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListAddressesResponseBody> = z
        .object({
            data: z.array(shared.Address$.outboundSchema),
...
export namespace ListAddressesResponse$ {
    export type Inbound = {
        ...
        StatusCode: number;
        RawResponse: Response;
        object?: ListAddressesResponseBody$.Inbound | undefined;
    };
    ...
    export const inboundSchema: z.ZodType<ListAddressesResponse, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            object: z.lazy(() => ListAddressesResponseBody$.inboundSchema).optional(),
        })
        .transform((v) => {
            return {
    ...
    export type Outbound = {
        ...
        StatusCode: number;
        RawResponse: never;
        object?: ListAddressesResponseBody$.Outbound | undefined;
    };
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListAddressesResponse> = z
        .object({
            ...
            object: z.lazy(() => ListAddressesResponseBody$.outboundSchema).optional(),
        })
        .transform((v) => {
            return {
                ContentType: v.contentType,
